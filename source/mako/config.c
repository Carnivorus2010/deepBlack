...
#include "config.h"
#include "deepblack_mako_defaults.h"
#include "criteria.h"
...
void init_default_style(struct mako_style *style) {
	...
	style->height = DB_MAKO_HEIGHT;

	style->outer_margin.top = DB_MAKO_OUTER_MARGIN;
	style->outer_margin.right = DB_MAKO_OUTER_MARGIN;
	style->outer_margin.bottom = DB_MAKO_OUTER_MARGIN;
	style->outer_margin.left = DB_MAKO_OUTER_MARGIN;

	style->margin.top = DB_MAKO_MARGIN;
	style->margin.right = DB_MAKO_MARGIN;
	style->margin.bottom = DB_MAKO_MARGIN;
	style->margin.left = DB_MAKO_MARGIN;

	style->padding.top = DB_MAKO_PADDING;
	style->padding.right = DB_MAKO_PADDING;
	style->padding.bottom = DB_MAKO_PADDING;
	style->padding.left = DB_MAKO_PADDING;

	style->border_radius.top = DB_MAKO_BORDER_RADIUS;
	style->border_radius.right = DB_MAKO_BORDER_RADIUS;
	style->border_radius.bottom = DB_MAKO_BORDER_RADIUS;
	style->border_radius.left = DB_MAKO_BORDER_RADIUS;

	style->border_size = DB_MAKO_BORDER_SIZE;
	...
	style->icons = false;
#endif
	style->max_icon_size = DB_MAKO_ICON_SIZE;
	style->icon_path = strdup("");  // hicolor and pixmaps are implicit.
	style->icon_border_radius = DB_MAKO_ICON_RADIUS;

	style->font = strdup(DB_MAKO_FONT);
	style->markup = true;
	style->format = strdup("<b>%s</b>\n%b");
	style->text_alignment = PANGO_ALIGN_LEFT;

	style->actions = true;
	style->default_timeout = DB_MAKO_DEFAULT_TIMEOUT;
	style->ignore_timeout = false;

	style->colors.background = DB_MAKO_BACKGROUND;
	style->colors.text = DB_MAKO_TEXT;
	style->colors.border = DB_MAKO_BORDER;
	style->colors.progress.value = DB_MAKO_PROGRESS;
	...
	style->max_visible = DB_MAKO_MAX_VISIBLE;
